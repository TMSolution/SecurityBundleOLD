...
//uprawnienia musza być zapisywane natychmiast
    ...
    public function create($entityObject, $executeImmediately = false, $logOperation = false, $checkRights = true)
    {
        ...
        parent::create($entityObject, $executeImmediately, $logOperation, $checkRights);
    ...
    public function getUserRights($user)
    {
        ...
        $qb = $this->getManager()->createQuery('SELECT objectidentity,right FROM Core\SecurityBundle\Entity\ObjectIdentity objectidentity LEFT JOIN Core\SecurityBundle\Entity\Right right WITH right.objectidentity = objectidentity and right.user = :user WHERE objectidentity.objectIdentityType = 2')
